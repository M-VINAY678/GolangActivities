...
const file_route_guide_proto_rawDesc = "" +
	...
	"\blocation\x18\x02 \x01(\v2\x11.routeguide.PointR\blocation\"Q\n" +
	"\tRectangle\x12!\n" +
	"\x02lo\x18\x01 \x01(\v2\x11.routeguide.PointR\x02lo\x12!\n" +
	"\x02hi\x18\x02 \x01(\v2\x11.routeguide.PointR\x02hi\"\x93\x01\n" +
	...
	"\felapsed_time\x18\x04 \x01(\x05R\velapsedTime\"T\n" +
	"\tRouteNote\x12-\n" +
	...
	"\tRouteChat\x12\x15.routeguide.RouteNote\x1a\x15.routeguide.RouteNote\"\x00(\x010\x01B\x1bZ\x19module_12_gRPC/routeguideb\x06proto3"
